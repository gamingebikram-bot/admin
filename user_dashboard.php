...
<head>
    ...
    <title>PRINCE MULTI PANEL Dashboard - Mod APK Manager</title>
    ...
    <style>
        /* Light, soft, dashboard style (PC + Mobile) */
        :root{
            --bg:#f3f4f6;           /* page */
            --card:#ffffff;         /* cards */
        ...
        /* Cards */
        .stats-card,.table-card,.mod-card{background:var(--card);border-radius:16px;padding:1rem 1rem;border:1px solid var(--line);box-shadow:0 8px 24px rgba(17,24,39,.04);} 
        .stats-card .text-muted{color:var(--muted)!important;}
        .stats-icon{width:46px;height:46px;border-radius:12px;background:var(--accent-100);color:var(--accent);font-size:1.25rem;}
        ...
        /* Content sizing */
        .main-content{margin-left:280px;padding:1.25rem;min-height:100vh;width:calc(100% - 280px);} 
        ...
        @media (max-width: 991.98px){
            ...
            .sidebar{width:100%;left:0;right:0;top:-105%;position:fixed;z-index:1000;border-right:none;border-bottom:1px solid var(--line);} 
            .sidebar.show{top:0;} 
            .mobile-overlay.show{display:block;}
            .page-header{margin-top:3.25rem;}
            .stats-card,.table-card,.mod-card{padding:.9rem;}
            .stats-icon{width:42px;height:42px;}
            .table thead th,.table tbody td{padding:.6rem;}
            /* Show mobile menu button for phones/tablets */
            .mobile-menu-btn{display:block;position:fixed;top:.75rem;left:.75rem;z-index:1101;background:var(--card);border:1px solid var(--line);color:var(--text);padding:.55rem .7rem;border-radius:10px;box-shadow:0 4px 14px rgba(17,24,39,.06);}            
        }
        @media (max-width:575.98px){
            .page-header{margin-top:3.6rem;}
            .user-avatar{width:38px;height:38px;}
            .stats-card,.table-card,.mod-card{padding:.7rem;}
        }
        
        /* Phone-first fine tuning */
        @media (max-width: 480px){
            body{font-size:14px;}
            .mobile-menu-btn{display:block;position:fixed;top:.65rem;left:.65rem;z-index:1100;background:var(--card);border:1px solid var(--line);color:var(--text);padding:.55rem .65rem;border-radius:10px;box-shadow:0 4px 14px rgba(17,24,39,.06);}            
            ...
            .stats-card{margin-bottom:.75rem;}
            .stats-card h2{font-size:1.4rem;}
            .stats-icon{width:40px;height:40px;font-size:1.05rem;border-radius:10px;}
            /* Force single-column cards */
            .col-md-4, .col-md-8, .col-md-6, .col-md-12{flex:0 0 100%;max-width:100%;}
            .table{font-size:.9rem;}
            .table thead th, .table tbody td{padding:.5rem;}
            .table-card .table-responsive{overflow-x:auto;-webkit-overflow-scrolling:touch;}
            /* Reduce shadows for compact look */
            .stats-card,.table-card,.mod-card{box-shadow:0 4px 16px rgba(17,24,39,.05);} 
        }
    </style>
    <style>
        /* Z-index stack for mobile to ensure nav is clickable */
        .mobile-menu-btn { z-index: 1202; }
        .mobile-overlay  { z-index: 1200; }
        .sidebar         { z-index: 1201; }

        /* Overlay sizing + clicks */
        .mobile-overlay{
            display: none;
            position: fixed;
            inset: 0;
